...
| `cross_validation_MAV.Rmd` | R Notebook containing code for cross validation of the MAV model. |
| `cross_validation_IAV.Rmd` | R Notebook containing code for cross validation of the temperature IAV model. |
